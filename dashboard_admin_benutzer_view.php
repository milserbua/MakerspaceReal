<?php
// dashboard_admin_benutzer_view.php
session_start();
require 'db.php';
...
// ---------------------------------------------------------
// 2. LOGIK: DATEN VERARBEITEN (UNVERÄNDERT)
// ---------------------------------------------------------
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'create') {
    ...
    $pass   = $_POST['passwort'];
    $role   = $_POST['rolle'];
    $klasse = trim($_POST['klasse']); // Klasse
...
<head>
    ...
    <style>
        ...
        /* BADGES */
        .badge { padding: 5px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <!-- WICHTIG: Active Class für Benutzer -->
